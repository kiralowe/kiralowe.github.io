...
library(network)
library(ggplot2)
links <- read_csv("Cosponsors_By_Bill_SENATE1.csv")  # bill file, convert into csv first
View(links)
nodes <- read_csv("CosponsorsByLegislatorSENATE1.csv") # legislator file, convert into csv first
View(nodes)
